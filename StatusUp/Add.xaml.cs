...
namespace StatusUp
{
    ...
    public sealed partial class Add : Page
    {
        ...
        {
            Uri x;
            bool result = Uri.TryCreate(link.Text, UriKind.Absolute,out x);
            
            if (result)
            {
                var values = new List<KeyValuePair<string, string>>{
                new KeyValuePair<string, string>("username",MainPage.user),
                new KeyValuePair<string, string>("service",link.Text)
            };
            ...
            {
                MessageDialog md = new MessageDialog("WRONG URL FORMAT");
                md.ShowAsync();
